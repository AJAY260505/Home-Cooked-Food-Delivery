    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          <h3 className="footer-heading">ComfortEats</h3>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li><a href="mailto:hello@ComfortEats.com" className="footer-link">hello@ComfortEats.com</a></li>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} ComfortEats. All rights reserved. | <Link to="/privacy" className="footer-link">Privacy Policy</Link> | <Link to="/terms" className="footer-link">Terms of Service</Link></p>
      </div>
    </footer>
  );
}